// Hero slider principale
if ($(".slider-page-title-home").length > 0) {
    var swiperHero = new Swiper(".slider-page-title-home", {
        spaceBetween: 0,
        slidesPerView: 1,
        effect: 'fade',
        fadeEffect: {
...
// Hero slider home6 variant
if ($(".slider-page-title-home6").length > 0) {
    var swiperHero6 = new Swiper(".slider-page-title-home6", {
        spaceBetween: 0,
        slidesPerView: 1,
        effect: 'fade',
        fadeEffect: {
...
// Slider con effetto fade (usato nel sito)
if ($(".slide-effect-fade").length > 0) {
    var swiperFade = new Swiper(".slide-effect-fade", {
        spaceBetween: 0,
        slidesPerView: 1,
        effect: 'fade',
        fadeEffect: {
...
if ($(".silde-follow-item").length > 0) {
    var swiperFollow = new Swiper(".silde-follow-item", {
        slidesPerView: 5,
        spaceBetween: 30,
        breakpoints: {
            0: {
